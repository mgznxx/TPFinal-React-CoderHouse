        ...
        <>
            ...
            <div className="container cartContainer">
                ...
                <div className="divButtons">
                    ...
                    <button className={`btn ${darkMode ? 'btn-info' : 'btn-info'}`}><Link  className="nav-link" to={'/'}>Continuar comprando</Link></button>
                    <button className={`btn ${darkMode ? 'btn-info' : 'btn-info'}`}><Link  className="nav-link" to={'/checkout'}>Finalizar Compra</Link></button>
                </div>   
            </div>
